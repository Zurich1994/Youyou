...
import com.example.youyou.service.LoadContactService;
import com.example.youyou.service.MyLocationService;
...
public class ActivitySupport extends Activity implements IActivitySupport {
	...
	protected YouyouApplication yoyoApplication;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		yoyoApplication = (YouyouApplication) getApplication();
		yoyoApplication.addActivity(this);
	...
	public void startService() {
		// 好友联系人服务
		Intent server = new Intent(context, ContactService.class);
		...
		//定位服务
//		Intent locationServer=new Intent(context, MyLocationService.class);
//		context.startService(locationServer);
//		// 自动恢复连接服务
...
//		context.stopService(imSystemMsgService);
	...
	@Override
	public YouyouApplication getYouyouApplication() {
	...
	public void startLoadService() {
		...
		Intent server = new Intent(context, LoadContactService.class);
		context.startService(server);
	}
