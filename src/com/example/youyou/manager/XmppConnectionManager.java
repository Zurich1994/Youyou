package com.example.youyou.manager;
...
public class XmppConnectionManager {
    ...
    public static void loadVCard () {
		// TODO Auto-generated method stub
    	try {
			myvCard.load(xmppConnectionManager.getConnection());
	...
	public static void setMyvCard(VCard myvCard) {
		XmppConnectionManager.myvCard = myvCard;
	}
