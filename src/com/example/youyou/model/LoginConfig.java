package com.example.youyou.model;
...
public class LoginConfig {
	...
	public String toString() {
		return "LoginConfig [xmppHost=" + xmppHost + ", xmppPort=" + xmppPort
				+ ", xmppServiceName=" + xmppServiceName + ", username="
				+ username + ", password=" + password + ", sessionId="
				+ sessionId + ", isRemember=" + isRemember + ", isAutoLogin="
				+ isAutoLogin + ", isNovisible=" + isNovisible + ", isOnline="
				+ isOnline + ", isFirstStart=" + isFirstStart + "]";
	}
